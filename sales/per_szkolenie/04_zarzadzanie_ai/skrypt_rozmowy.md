# Skrypt rozmowy: Nowoczesna skuteczność w pracy: zarządzanie czasem, energią, motywacją i AI

**Cel:** Zamknąć rezerwację miejsca na szkolenie (15 czerwca 2026 - 19 czerwca 2026).
...
1. Czy Państwa zespół używa już narzędzi AI (ChatGPT, Copilot, Canva AI) w codziennej pracy?
...
- "Używamy ChatGPT ale powierzchownie" → szkolenie pokazuje systematyczne zastosowania
- "Nie mamy czasu na cyfryzację" → szkolenie w 50h daje gotowe narzędzia
- "Nie korzystaliśmy z KFS" → edukacja: 90% dofinansowania + pomagamy z wnioskiem
...
> Cena katalogowa to 8 750 zł za uczestnika za 50 godzin. Z KFS 2026 mikrofirma może uzyskać dofinansowanie do **90%**. Wkład Państwa to **875 zł** za osobę.

### Dla firm 10+ osób:

> KFS dla firmy powyżej 10 pracowników to 70% dofinansowania, wkład Państwa to **2 625 zł**.
...
**1. Program.**
> 50 godzin praktycznego warsztatu. Nie teoria - konkretne narzędzia które Państwa zespół zacznie używać od razu po szkoleniu.
...
**3. Dofinansowanie.**
> Mikrofirma: 875 zł wkładu własnego zamiast 8 750 zł. Firma 10+: 2 625 zł. IRIN jest w BUR (ID 160205, ocena 4.9/5).
...
> - Doświadczenie w ai potwierdzone certyfikacją BUR
...
> Termin to 15 czerwca 2026 - 19 czerwca 2026, zdalnie. Mamy ograniczoną liczbę miejsc. Żeby zarezerwować, potrzebuję: liczby uczestników, danych firmy do umowy. Mogę dziś wysłać formularz?
...
> Zatrzymajmy się. Co Państwo nazywają "drogim" - 8 750 zł cena katalogowa, czy 875 zł po dofinansowaniu? Bo to dwie różne rozmowy.
...
- 🌐 [Profil szkolenia w BUR](https://uslugirozwojowe.parp.gov.pl/wyszukiwarka/uslugi/podglad?id=3386476)
