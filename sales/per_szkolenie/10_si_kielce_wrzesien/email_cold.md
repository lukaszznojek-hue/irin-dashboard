...
1. `[Firma_klienta] - kurs integracji sensorycznej z certyfikatem BUR + 90% dofinansowania KFS`
2. `120h kurs integracji sensorycznej za 931 zł (KFS 90%) - Kielce`
3. `Rozszerzenie oferty terapeutycznej Państwa placówki - kurs z BUR PARP`
4. `77.58 zł/h za kurs specjalistyczny vs rynek 120+ zł/h`
...
piszę w sprawie możliwości rozszerzenia kompetencji Państwa zespołu
...
⏱️ 120 godzin dydaktycznych
🌐 mieszana (Kielce + online)
💰 9 310 zł brutto/os. → mikrofirma KFS 90% = 931 zł

Po kursie Państwa specjalista:
