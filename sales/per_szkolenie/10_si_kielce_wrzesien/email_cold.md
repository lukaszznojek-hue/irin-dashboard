# Email cold: Integracja sensoryczna w ujęciu neurofizjologicznym – kurs I i II stopnia z zakresu diagnozy i terapii

**Cel:** Pierwszy kontakt - umówienie rozmowy telefonicznej (15 min).
**Persona:** Dyrektor placówki edukacyjnej / Pedagog / Psycholog szkolny / Fizjoterapeuta / Logopeda

---

## Subject line - warianty

1. `Kurs integracji sensorycznej z certyfikatem BUR - dofinansowanie do 90% (KFS)`
2. `[Firma_klienta] - rozszerzenie kompetencji zespołu w zakresie integracji sensorycznej`
3. `120h kurs integracji sensorycznej, Kielce - 77.58 zł/h`
...
zwracam się w sprawie możliwości podniesienia kwalifikacji
Państwa zespołu w zakresie integracji sensorycznej.
...
---
Integracja sensoryczna w ujęciu neurofizjologicznym – kurs I i II stopnia z zakresu diagnozy i terapii

Termin:    8 września 2026 - 25 października 2026
Wymiar:    120 godzin dydaktycznych
Forma:     mieszana (Kielce + online)
Cena:      9 310 zł brutto/os.
Po dofinansowaniu KFS (mikrofirma 90%): 931 zł

Po ukończeniu kursu specjalista:
...
https://uslugirozwojowe.parp.gov.pl/wyszukiwarka/uslugi/podglad?id=3486195
```
